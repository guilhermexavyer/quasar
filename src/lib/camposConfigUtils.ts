...
export const CAMPOS_POR_FUNCAO: Record<string, CampoDef[]> = {
  ...
  relatorio: [
    ...
    { key: "relatorio_bandas.ds_banda", label: "Banda", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_tipo_banda", label: "Tipo", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_colecao_principal", label: "Coleção principal", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.nr_posicao", label: "Posição", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.nr_altura", label: "Altura", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_borda_superior", label: "Borda superior", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_borda_inferior", label: "Borda inferior", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_borda_esquerda", label: "Borda esquerda", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
    { key: "relatorio_bandas.ie_borda_direita", label: "Borda direita", tipo: "Relatórios > Bandas", colecao: "relatorio_bandas" },
  ],
  estruturaAcademica: [
