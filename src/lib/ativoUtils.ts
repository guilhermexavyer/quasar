...
export const FIELD_INFOS = {
  ...
  dt_reativacao: { type: 'string', field: 'dt_reativacao', collection: 'pat_ativo' },
  ...
  dt_descarte: { type: 'string', field: 'dt_descarte', collection: 'pat_ativo' },
  ds_descarte: { type: 'string', field: 'ds_descarte', collection: 'pat_ativo' },
